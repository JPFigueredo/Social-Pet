...
class AddPostFragment : Fragment() {
    ...
    private fun savePost() {
        ...
        val petPhoto = petMainViewModel.petMain_photoVM.value.toString()
        val datePost = getDate()
        val locationPost = addressPost
        val newPost = Post(petPhoto, encodedImageString, petName, datePost, "0", getSecPost(), descriptionPost, locationPost)
